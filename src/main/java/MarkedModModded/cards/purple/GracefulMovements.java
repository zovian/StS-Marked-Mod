...
import MarkedModModded.powers.watcher.GracefulMovementsPower;
...
public class GracefulMovements
    ...
    public static final String ID = MarkedModModded.makeID(GracefulMovements.class.getSimpleName());
