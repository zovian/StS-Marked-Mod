...
import MarkedModModded.powers.watcher.ApplyMarkOnAttackedPower;
import MarkedModModded.powers.watcher.GainBlockOnApplyMarkPower;
...
public class PinPointDefense
    ...
    public static final String ID = MarkedModModded.makeID(PinPointDefense.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = PinPointDefense.class.getSimpleName();
