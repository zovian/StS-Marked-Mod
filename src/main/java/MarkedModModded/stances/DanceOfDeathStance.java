package MarkedModModded.stances;

import MarkedModModded.MarkedModModded;
import MarkedModModded.abstracts.AbstractCustomStance;
import MarkedModModded.actions.RemoveHalfBlockAction;
import MarkedModModded.actions.TriggerMarkAction;
import MarkedModModded.vfx.stance.DanceOfDeathParticleEffect;
...
public class DanceOfDeathStance
    ...
    public static final String STANCE_ID = MarkedModModded.makeID(DanceOfDeathStance.class.getSimpleName());
    ...
    public static Color getColor(float a) {
        if (cachedColor == null) {
            ...
            MarkedModModded.logger.info("Caching new color: " + cachedColor.toString());
        }
